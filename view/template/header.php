...
<head>
  ...
  <style>
    ...
    .floating-button {
      ...
      cursor: pointer;
      z-index: 1000;
      /* Aseg�rate de que el bot�n est� siempre en la parte superior */
    }
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2"> <!-- Aca se crean cada una de las opciones del sidebar -->
          <!-- Lista desordenada con cada opcion del sidebar. Cada li de la lista se crea dependiendo de si existe o no existe su sesión -->
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            /* ------ Seccion para la creacion de cada uno de los li (list items) que conforman al Sidebar: Para cada uno se necesita validar que su respectiva sesión exista antes de generar codigo html
            */

            if ($_SESSION['escritorio'] == 1) { // li para la opción de "escitorio"
              echo '<li class="nav-item">
            ...
            <?php
            if ($_SESSION['SolicitudesBiberones'] == 1) { // li para la opción de SolicitudesBiberones
              echo '<li class="nav-item">
