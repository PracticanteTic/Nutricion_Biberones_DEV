...
?>
    ...
    <div class="content-wrapper"> <!-- Caja contenedora del main, contiene todo el contenido principal -->
      <form id="actualizarEstado" method="POST"> <!-- Este formulario solo sale dentro del modal cuando se le da click al btn de cambiar estado (En cada registro de la tabla) -->
                ...
                <div class="container">
                  ...
                  ?>
                    <select class="form-select" name="seleccionar_estado" id="seleccionar_estado">
                      ...
                      foreach ($ejecutar as $opciones): // Retorna un 
              ...
              <?php } else { ?>
                ...
                <select class="form-select" name="seleccionar_estado" id="seleccionar_estado">
                  <?php
                    ...
                    $ejecutar = mysqli_query($conexion, $consultar) or die(mysqli_error($conexion));
                    foreach ($ejecutar as $opciones): // Crea un option para cada uno de los estados obtenidos de la tabla de estados

                  ?>
                    <option selected disabled hidden>Seleccione estado</option>
                    <option value='<?php echo $opciones['id'] ?>'> <!-- La opcion es un estado [id,estado, activo, activo_nutricionista], usa el id del estado -->
                      <?php


                      ?>
                      <?php
                      echo $opciones['estado'] // Muestra el nombre de la opcion [En proceso, Entreagado, Recibido]
                      ?>
                    </option>
                  <?php
                    endforeach
