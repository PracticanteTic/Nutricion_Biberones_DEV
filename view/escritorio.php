      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Div contenedor para almacenar las tablas presentes en el home (escritorio) -->
            <div class="table-responsive">
              <table> <!-- Primera tabla -->
                <thead> <!-- Encabezados tabla-->
                ...
                <tbody>
                  <tr> <!-- Si este tr se quita, se le aplica un color diferente -->
                  </tr>
                  <tr>
                    <td>Tanda 1: Mañana</td>
                    <td>12:00 a 15:00</td>
                    <td>6:00</td>
                    <td>10:00 a 10:30</td>
                    <td>8:00</td>
